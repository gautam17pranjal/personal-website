...
const BriefWorkSection = () => {
    ...
    return (
        <div className="border border-zinc-800 rounded-xl py-4 shadow-lg px-4 md:px-8">
            ...
            <div className="mt-5 mb-3 pl-[25%] bg-zinc-800 hover:bg-zinc-700 hover:cursor-pointer py-1.5 rounded-lg">
                <Link
                ...
                >
                    <span className="flex flex-row items-center text-white text-sm font-medium">
                        <span className="pr-3">Download Resume</span>
