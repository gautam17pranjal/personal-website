...
const educationData: Education[] = [
    {id: 1, school: "University of Southern California", type: "M.S.(Computer Science)", start: "2021", end: "2022", logo: ""},
    {id: 2, school: "Netaji Subhas Institute of Technology", type: "B.E.Information Technology", start: "2014", end: "2018", logo: ""},
    {id: 3, school: "Mount Carmel School", type: "High School", start: "2009", end: "2013", logo: ""}
]

const Education = () => {
    return (
        <div className="border border-zinc-800 rounded-xl border-t py-4 mb-8 shadow-lg px-4 md:px-5">
